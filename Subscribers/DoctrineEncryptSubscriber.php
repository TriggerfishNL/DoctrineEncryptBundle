...
namespace Triggerfish\DoctrineEncryptBundle\Subscribers;
...
use \ReflectionClass;
use Triggerfish\DoctrineEncryptBundle\Encryptors\EncryptorInterface;
...
class DoctrineEncryptSubscriber implements EventSubscriber {
     ...
     */
    const ENCRYPTOR_INTERFACE_NS = 'Triggerfish\DoctrineEncryptBundle\Encryptors\EncryptorInterface';

    /**
     * Encrypted annotation full name
     */
    const ENCRYPTED_ANN_NAME = 'Triggerfish\DoctrineEncryptBundle\Configuration\Encrypted';
